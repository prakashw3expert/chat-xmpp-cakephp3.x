...
//$tableHeaders[] = array($this->Paginator->sort(__('id')) => array('style' => 'width:10%'));
$tableHeaders[] = array($this->Paginator->sort(__('name'), 'Language Name') => array('style' => 'width:40%'));
...
echo $this->Form->create($languages, array(
    'novalidate' => true,
    'type' => 'get',
    'class' => 'form-inline',
));
